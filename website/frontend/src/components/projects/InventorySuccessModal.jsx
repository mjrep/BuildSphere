    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 p-4">
            <div className="bg-card rounded-3xl shadow-2xl w-full max-w-sm relative p-8 flex flex-col items-center animate-in fade-in zoom-in-95 duration-200">
                <div className="w-20 h-20 bg-accent rounded-full flex items-center justify-center shadow-lg shadow-[#706BFF]/30 mb-6">
                ...
                <button
                    onClick={onClose}
                    className="w-full py-2.5 text-sm font-bold text-white bg-accent hover:opacity-90 rounded-xl transition-colors"
                >
                    Back to Inventory
                </button>
            </div>
