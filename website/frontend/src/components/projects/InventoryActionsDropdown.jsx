...
export default function InventoryActionsDropdown({ item, onEdit, onUpdateStock, onViewHistory, onDelete }) {
    ...
    const MenuContent = (
        <div 
            ...
            className="w-48 rounded-[1.25rem] shadow-2xl shadow-black/20 bg-card ring-1 ring-black ring-opacity-5 py-2 animate-in fade-in slide-in-from-top-2 duration-200"
        >
            <div className="px-3 pb-1 border-b border-border-primary mb-1">
                <span className="text-[10px] font-bold text-text-muted uppercase tracking-wider">Item Actions</span>
            </div>
            ...
            <button
                ...
                className="w-[calc(100%-8px)] mx-1 flex items-center gap-3 px-3 py-2 text-sm text-accent hover:bg-indigo-50 rounded-xl transition-colors font-semibold group"
            >
                <div className="w-7 h-7 bg-indigo-50 group-hover:bg-card rounded-lg flex items-center justify-center transition-colors">
            ...
            >
                <div className="w-7 h-7 bg-emerald-50 group-hover:bg-card rounded-lg flex items-center justify-center transition-colors">
            ...
            >
                <div className="w-7 h-7 bg-red-50 group-hover:bg-card rounded-lg flex items-center justify-center transition-colors">
