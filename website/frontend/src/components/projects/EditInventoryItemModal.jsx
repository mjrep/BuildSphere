    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md relative animate-in fade-in zoom-in-95 duration-200">
                ...
                <h3 className="text-lg font-bold text-center text-[#706BFF] pt-6 pb-2 border-b border-[#F0F0F8]">Edit the Item</h3>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-bold text-[#1A1A1A] mb-1">Critical Level</label>
                        <input 
                            name="critical_level"
